...
Dịch file SRT sang bất kỳ ngôn ngữ nào bằng AI. Xử lý theo lô (batch), giữ nguyên format và timing SRT, xuất file SRT mới.
...
2. **Ngôn ngữ dịch** - ví dụ: "Vietnamese", "English", "Japanese" (default: Vietnamese)
